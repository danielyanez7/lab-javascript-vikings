...
addViking(Viking(daniel, 100, 100))
addViking(Viking(juan, 10, 10))
addViking(Viking(maria, 50, 34))
addViking(Viking(josefina, 94, 70))
addViking(Viking(tiburcio, 90, 55))

addSaxon(Saxon(100, 20))
addSaxon(Saxon(100, 100))
addSaxon(Saxon(90, 10))
addSaxon(Saxon(40, 100))
addSaxon(Saxon(80, 60))
